...
authRouter.post("/create-organization", authMiddleware, async (req: Request, res: Response) => {
...
authRouter.post("/invite-member-to-organization", authMiddleware, async (req: Request, res: Response) => {
